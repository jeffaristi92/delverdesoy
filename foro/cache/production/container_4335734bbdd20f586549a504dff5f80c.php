...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000400cda600000000562b008e(
...
class phpbbtemplatetwiglexer_000000000400cda600000000562b008e extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bce074c04263477771087 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bce074c04280483407240 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bce074c0422a542836837 = array(
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, 'set_environment', array('env' => $env), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        return $this->valueHolder5bce074c04263477771087->set_environment($env);
    }
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        return $this->valueHolder5bce074c04263477771087->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        return $this->valueHolder5bce074c04263477771087->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bce074c04280483407240 = $initializer;
    }
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__get', array('name' => $name), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        if (isset(self::$publicProperties5bce074c0422a542836837[$name])) {
            return $this->valueHolder5bce074c04263477771087->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bce074c04263477771087;
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__isset', array('name' => $name), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__unset', array('name' => $name), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;
    ...
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__clone', array(), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        $this->valueHolder5bce074c04263477771087 = clone $this->valueHolder5bce074c04263477771087;
    }

    public function __sleep()
    {
        $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, '__sleep', array(), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;

        return array('valueHolder5bce074c04263477771087');
    }
    ...
    {
        return $this->initializer5bce074c04280483407240;
    }
    ...
    {
        return $this->initializer5bce074c04280483407240 && ($this->initializer5bce074c04280483407240->__invoke($valueHolder5bce074c04263477771087, $this, 'initializeProxy', array(), $this->initializer5bce074c04280483407240) || 1) && $this->valueHolder5bce074c04263477771087 = $valueHolder5bce074c04263477771087;
    }
    ...
    {
        return null !== $this->valueHolder5bce074c04263477771087;
    }
    ...
    {
        return $this->valueHolder5bce074c04263477771087;
    }
