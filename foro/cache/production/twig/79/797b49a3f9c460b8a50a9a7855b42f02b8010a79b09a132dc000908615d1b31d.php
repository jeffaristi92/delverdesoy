...
/* acp_icons.html */
class __TwigTemplate_51a43395ad6b42acd070fc1f08a21dc1e0fcfa0506e81a7c97baf3cc8a704956 extends Twig_Template
{
...
\t\t\t";
                ...
                $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "smile", array()));
...
\t";
            // line 82
            if ((twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "items", array())) || ($context["S_ADD_CODE"] ?? null))) {
                // line 83
                echo "\t<tr class=\"row3\">
\t\t<td>";
                // line 84
...
\t";
                // line 105
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "items", array()));
