...
/* overall_footer.html */
class __TwigTemplate_049d45a2b3e8a904c3a2c999758973d444094c1aa40c7e49bb428222dae333d7 extends Twig_Template
{
...
";
        // line 6
        if (($this->getAttribute(($context["definition"] ?? null), "WRAP_FOOTER", array()) == 0)) {
            // line 7
            echo "\t";
...
\t";
        // line 12
        if (($this->getAttribute(($context["definition"] ?? null), "WRAP_FOOTER", array()) == 1)) {
            // line 13
            echo "\t\t";
            $location = "navbar_footer.html";
            $namespace = false;
